...
public:
  ...
  explicit constexpr CommonReq_HeadersEntry_DoNotUse(
...
class CommonReq final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_reqid();
...
public:
  ...
  explicit constexpr CommonResp_HeadersEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class CommonResp final :
 ...
 public:
  ...
  ~CommonResp() override;
  explicit constexpr CommonResp(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void CommonReq::set_reqid(ArgT0&& arg0, ArgT... args) {
 ...
 reqid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CommonReq::_internal_set_reqid(const std::string& value) {
  ...
  reqid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CommonReq::_internal_mutable_reqid() {
  
  return reqid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CommonReq::release_reqid() {
  // @@protoc_insertion_point(field_release:snail.stream.CommonReq.reqid)
  return reqid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
